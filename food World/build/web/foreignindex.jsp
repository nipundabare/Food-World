                    ...
                    <div class="col-md-6 extra-info">
                      <div class="row">
                        <div class="col-md-6 mb-5">
                          <h3>Contact Info</h3>
                          <p>"Nimali", Duwa tempe Rd <br> Hoamagama</p>
                          <p>webadmin@gmail.com</p>
                          <p>+94777777777</p>
        ...
        <%
            ...
            for (localpost post : posts) {
               ...
               <div class="col-lg-3 col-md-6 visit mb-3" data-aos="fade-right">
                    <a href="#.html">
                       <img src="resources/<%= post.getImage()%>" height="250;" width="250" style="border-radius: 8px;"/></a>
                    <h3><a href="#.html"><%=post.getTitle()%></a></h3>
                    <div class="reviews-star float-left">
                     <%=post.getDescription()%>
                    </div>
                    <form action="#.jsp">
                    <span class="reviews-count float-right">
                        <% String tel;int userid = post.getUid();
                        ResultSet search = DB.search("SELECT `tel` FROM `locals` WHERE id = '"+userid+"'");
                        if (search.next()) {tel = search.getString(1);out.print(tel);}
                        %>
                    </span>
                    </form>
                </div>
      ...
      <div class="container">
        <div class="row mb-4">
          ...
          <div class="col-md-3 mb-5 pr-md-5 contact-info">
            <p><span class="d-block">Address:</span> <span> "Nimali", Duwa temple Rd<br>Kaluthara</span></p>
